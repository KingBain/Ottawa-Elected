...
//bong build my own infor box :)  




var html = '<div id="ward_name">Info is being generated</div>' +
	   '<div id="ward_ward">Info is being generated</div>' +
	   '<div id="ward_web">Info is being generated</div>' +
	   '<div id="ward_twitter">Info is being generated</div>' +
	   '<div id="ward_youtube">Info is being generated</div>' +
	   '<div id="ward_phone">Info is being generated</div>';
...
GEvent.addListener(p,"mouseover",p.onOver);
  ...
  GEvent.addListener(p,"click", function(point, overlay) {
	...
	if(!point){ 
		...
		setTimeout("new Ajax.Request('/candidates/get_ajax/"+unescape(op.description)+"')", 50)
   		
		//new Ajax.Request('/candidates/get_ajax/'+unescape(op.description));
